...
void main() {
  testWidgets('LogoVideoPlayer can be instantiated', (WidgetTester tester) async {
    const widget = LogoVideoPlayer(
    ...
    expect(find.byType(LogoVideoPlayer), findsOneWidget);
  });
  
  testWidgets('LogoVideoPlayer with custom parameters', (WidgetTester tester) async {
    const widget = LogoVideoPlayer(
      videoUrl: 'https://example.com/video.mp4',
      width: 400,
      height: 300,
